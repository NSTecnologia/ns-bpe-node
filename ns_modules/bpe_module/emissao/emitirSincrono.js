...
class ResponseSincrono {
    constructor(statusEnvio, statusConsulta, statusDownload, cStat, motivo, xMotivo, nsNRec, chBPe, nProt, xml, json, pdf, erros) {
...
async function emitirBPeSincrono(conteudo, tpAmb, tpDown, caminhoSalvar) {
...
module.exports = { ResponseSincrono, emitirBPeSincrono }
